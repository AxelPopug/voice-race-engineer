...
- первоначальный SDK-кандидат: `SVappsLAB.iRacingTelemetrySDK`, изолированный собственным adapter;
...
- голосовой интерфейс: push-to-talk, `Whisper.net`, Silero VAD, локальный TTS через `sherpa-onnx`, разговорный orchestrator с tool calling;
...
- `.NET 10` является LTS-релизом и дает актуальный runtime, JIT и C# 14 для нового проекта без legacy-ограничений.
- Библиотеки, таргетирующие `net8.0`, могут использоваться из `net10.0` приложения; совместимость проверяется spike-тестами.
...
- [Исследование C#/.NET библиотек iRacing SDK](../research/0002-dotnet-iracing-sdk-libraries.md)
- [Исследование локального STT/TTS стека](../research/0003-local-stt-tts-stack.md)
- [Архитектура детерминированного Strategy Engine](../architecture/0001-strategy-engine.md)
- [Общий технический roadmap](../plan/0001-technical-roadmap.md)
